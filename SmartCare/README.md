...
<p align="center">
  <strong>One platform. Every hospital operation. Zero paper.</strong><br/>
  From patient registration to AI triage, live doctor queues, predictive pharmacy, and admin analytics — SmartCare digitizes the entire hospital workflow in a single, real-time application.
</p>

<p align="center">
  <a href="#-try-it-live"><img src="https://img.shields.io/badge/🚀_TRY_THE_LIVE_DEMO-Click_Here-indigo?style=for-the-badge&labelColor=4F46E5&color=6366F1" /></a>
</p>
...
> **Experience SmartCare right now — no installation needed!**

<p align="center">
  <a href="#">
    <img src="https://img.shields.io/badge/▶_LIVE_DEMO-Launch_SmartCare-4F46E5?style=for-the-badge&logo=vercel&logoColor=white&labelColor=312E81" />
  </a>
</p>

<p align="center">
  <em>🔗 Live link will be added after deployment — stay tuned!</em>
</p>

> **Test Credentials:**
> | Role | Login | Password |
> |------|-------|----------|
> | Patient | `P1001` | *(set during registration)* |
> | Staff | Register via Login → Staff → Register |
> | Doctor | Register via Login → Doctor → Register |
> | Admin | Register via Login → Admin → Register |
...
> *"In a world where you can order food in 5 taps, why should hospital administration take 50 forms?"*
...
> *SmartCare serves as a comprehensive proof-of-concept that all hospital administration — from patient intake to discharge analytics — can be unified into a single, AI-enhanced, real-time web application.*
